...
public class DialogFragment extends android.support.v4.app.DialogFragment{
    ...
    public interface Builder{
        public com.theironingboard.material.app.Dialog build(Context context);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        com.theironingboard.material.app.Dialog dialog = mBuilder == null ? new Dialog(getActivity()) : mBuilder.build(getActivity());
