...
public class TabPageIndicator1 extends HorizontalScrollView implements ViewPager.OnPageChangeListener, android.view.View.OnClickListener {
	...
	public TabPageIndicator1(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public TabPageIndicator1(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
		super(context, attrs, defStyleAttr);
	...
	private void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
		...
		int indicatorColor = a.getColor(R.styleable.TabPageIndicator_tpi_indicatorColor, ThemeUtil.colorAccent(context, 0xFFF91515));// 0xFFFFFFFF));
		mIndicatorHeight = a.getDimensionPixelSize(R.styleable.TabPageIndicator_tpi_indicatorHeight, ThemeUtil.dpToPx(context, 5));
		...
		mPaint.setColor(getResources().getColor(R.color.red_clr));
	}
	...
	private CheckedTextView getTabView(int position) {
		// (CheckedTextView) mTabContainer.getChildAt(position).set
	...
	public void onPageScrollStateChanged(int state) {
		...
		if (state == ViewPager.SCROLL_STATE_IDLE) {
			...
			getTabView(mSelectedPosition).setTypeface(face);
			// getTabView(mSelectedPosition).setTypeface(face,Typeface.BOLD);
