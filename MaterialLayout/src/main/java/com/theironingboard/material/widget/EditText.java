...
public class EditText extends FrameLayout {
	 ...
	 * <p>
	 * In 1.0, the {@link android.text.TextWatcher#afterTextChanged} method was
	 ...
	 * 
	 * @return the default {@link java.util.Locale} of the text in this
	 *         TextView.
	 */
	@TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
	 ...
	 * {@link android.view.inputmethod.InputConnection#commitCorrection}
	 ...
	 * {@link android.view.ActionMode.Callback#onPrepareActionMode(android.view.ActionMode, android.view.Menu)}
	 ...
	 * {@link android.view.ActionMode.Callback#onCreateActionMode(android.view.ActionMode, android.view.Menu)}
	 ...
	 * by
	 * {@link #extractText(android.view.inputmethod.ExtractedTextRequest, android.view.inputmethod.ExtractedText)}
	 * .
	 */
	 ...
	 * {@link android.view.inputmethod.EditorInfo#extras
	 ...
	 * {@link android.view.inputmethod.EditorInfo#inputType}. This will take
	 ...
	 * {@link android.view.inputmethod.EditorInfo#TYPE_NULL} then a soft
	 ...
	 * {@link android.view.inputmethod.EditorInfo#TYPE_TEXT_FLAG_MULTI_LINE}
	 ...
	 * {@link android.text.method.KeyListener#getInputType()
	 ...
	 *
	 * @param locale
	 *            the {@link java.util.Locale} for drawing text, must not be
	 *            null.
	 *
	 ...
	 * {@link android.util.TypedValue} for the possible dimension units.
	 *
	 * @param unit
	 ...
	 * you may need to use {@link #setTypeface(android.graphics.Typeface, int)}
